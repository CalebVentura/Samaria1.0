      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Vida Devocional</span>
          </a>
          <ul class="treeview-menu">
            <li><a href="lista-devocional.php"><i class="fa fa-list-ul"></i> Ver Todos</a></li>
            <li><a href="crear-devocional.php"><i class="fa fa-plus-circle"></i> Agregar</a></li>
          </ul>
        </li>
