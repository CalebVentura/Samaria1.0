<?php include_once 'template/header.php';?>
        ...
        <div class="px-0">
            <div class="row">
                <div class="col-12 pt-5 px-5 text-justify">
                    ...
                    <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis non itaque incidunt dolore fuga consequuntur quas, voluptatum. Eos, eaque eligendi cupiditate repellat mollitia voluptate atque voluptatem aliquam! Nobis incidunt molestiae possimus facere modi non, distinctio totam nulla fugit quisquam esse omnis repellat neque, temporibus officiis atque magnam, culpa reprehenderit excepturi labore expedita ducimus. Quae obcaecati quas placeat libero consequatur nulla dolores enim id excepturi sit iusto dolorum reiciendis unde autem quia adipisci aliquam perspiciatis minima, accusantium, tempora, reprehenderit deserunt culpa! Non praesentium quibusdam iusto aliquam possimus ad eaque officiis expedita voluptates numquam recusandae repudiandae, facere minima nulla quia!</p>
                </div>
            </div>
        </div>
        ...
        <div class="uk-container uk-margin-medium-top uk-margin-medium-bottom">
            <div class="uk-child-width-1-2@s uk-child-width-1-1 uk-grid-collapse" uk-grid>
                <div class="colaboradores">
                    <img src="img/equipo/p1.jpg" alt="">
                    <div class="uk-text-center  uk-padding-small"><h3>Ps. Austreberto Suarez y Violeta Erazo </h3></div>
                </div>
                <div class="colaboradores">
                    <img src="img/equipo/p2.jpg" alt="">
                    <div class="uk-text-center  uk-padding-small"><h3>Ps. David Medina y Nathy Suarez</h3></div>
                </div>
            </div>
        </div>
